...
KUBERNETES_KUBELET_VERSION = 1.28.8
...
define KUBERNETES_KUBELET_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(KUBERNETES_KUBELET_MAKE_ENV) $(MAKE1) -C $(@D) all WHAT="cmd/kubelet" GOFLAGS="-trimpath -buildvcs=false" KUBE_BUILD_PLATFORMS="linux/$(GO_GOARCH)"
endef
