...
KUBERNETES_KUBELET_VERSION = 1.20.0
...
define KUBERNETES_KUBELET_INSTALL_INIT_SYSTEMD
	...
	# "https://raw.githubusercontent.com/kubernetes/release/$(KUBERNETES_KUBEPKG_RELEASE_VERSION)/cmd/kubepkg/templates/latest/deb/KUBELET/10-KUBELET.conf"
