...
KUBERNETES_KUBELET_VERSION = 1.24.0
...
KUBERNETES_KUBEPKG_RELEASE_VERSION = v0.13.0

define KUBERNETES_KUBELET_BUILD_CMDS
	$(TARGET_MAKE_ENV) $(MAKE1) -C $(@D) generated_files
	$(TARGET_MAKE_ENV) $(MAKE1) -C $(@D) all WHAT="cmd/kubelet" KUBE_BUILD_PLATFORMS="linux/$(GO_GOARCH)"
endef
